...
const packages = [
  ...
  ["commons", "pc", "shared-ui", { "@sdkwork/ui-pc-react": "workspace:*", react: "catalog:", "react-router-dom": "^7.15.0", "lucide-react": "catalog:" }],
