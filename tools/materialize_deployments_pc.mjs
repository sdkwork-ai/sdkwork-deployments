...
const packages = [
  ...
  ["console-sites", "app-console", "sites", { "@sdkwork/deployments-pc-commons": "workspace:*" }, null, [["sites", "Applications", "Application lifecycle and availability", "deploy.sites.read"]]],
  ["console-site-configuration", "app-console", "site-configuration", { "@sdkwork/deployments-pc-commons": "workspace:*" }, null, [["configuration", "Configuration", "Environment variables and health checks", "deploy.sites.read"]]],
  ...
  ["console-monitoring", "app-console", "monitoring", { "@sdkwork/deployments-pc-commons": "workspace:*" }, null, [["monitoring", "Monitoring", "Health check policy and status", "deploy.healthChecks.read"]]],
