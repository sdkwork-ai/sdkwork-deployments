# Runbook — sdkwork-deployments deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-deployments-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-deployments/bundle`, loads the image, starts
